...
vim.keymap.set('n', '<leader>sc', ':lua require("config.utils").toggle_spell_check()<CR>',
    { desc = "Toggle spell check", silent = true })
vim.keymap.set('n', '<leader>li', ':lua require("config.ledger").generate_transaction_info()<CR>',
