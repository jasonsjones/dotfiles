...
plugins=(git node npm yarn docker docker-compose tmux zsh-autosuggestions)

# User configuration

export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:$HOME/blt:$HOME/bin"
...
export P4CLIENT=jasonjones-ltm-blt
